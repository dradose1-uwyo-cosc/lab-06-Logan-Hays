...
# Sources, people worked with, help given to: Calvin Howard and Patrick Tully 
# your
# comments
# here
...
for key in letters.keys():
    if letters[most_occurred] < letters[key]:
        most_occurred = key
    elif letters[key] < letters[least_occurred]:
        least_occurred = key
